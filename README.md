...
- **Interface Selection** — choose which network interface to operate on (<u>*NEW!*</u>)
- **Scan Export** - save full nmap output to .txt file via native file manager dialog (<u>*NEW!*</u>)
